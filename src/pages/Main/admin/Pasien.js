...
const Pasien = () => {
  ...
  const tambahPasien = async () => {
    try {
      const response = await setDoc(doc(fs, "pasien", "+62" + form.number), {
        name: form.name,
        adress: form.adress,
        number: "+62" + form.number,
      });
      if (response) {
        console.log("tambah pasien sukses");
      }
    } catch (error) {
      console.log("tambah pasien", error);
    }
  };
      ...
      >
        <Modal.Content maxWidth="400px">
          ...
          {Object.keys(data).length <= 0 ? (
            <Fragment>
              <Modal.Header>Tambah Pasien</Modal.Header>
              <Modal.Body>
                <VStack space={3}>
                  <FormControl>
            ...
            <Fragment>
              <Modal.Header>Profil Pasien</Modal.Header>
              <Modal.Body>
                <Fragment>
                  <VStack>
                    <HStack space={5}>
